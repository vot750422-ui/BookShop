...
// Tính tổng tiền và lấy thông tin sách từ DB
$TongTien = 0;
$items    = [];
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Nút xoá -->
                        <form method="POST" style="display:inline;"
                              onsubmit="return confirm('Xoá sách này khỏi giỏ?')">
                            <input type="hidden" name="BookID" value="<?php echo $item['BookID']; ?>">
                            <button type="submit" name="action" value="delete" class="btn-xoa">
                                🗑 Xoá
                            </button>
                        </form>
                    </td>
        ...
        <div class="btn-group">
            <div>
                ...
                <form method="POST" style="display:inline;"
                    ...
                    <button type="submit" name="action" value="xoa-het" class="btn-xoa"
            ...
            <div style="display:flex; gap:10px;">
                ...
                <!-- Truyền tổng tiền sang trang thanh toán -->
                <a href="Thanhtoan.php?tongTien=<?php echo $TongTien; ?>"
                   class="btn-thanhtoan">
                    Thanh toán →
                </a>
            </div>
